...
- MVP-001 : `ACTIVE - IMPLEMENTATION`, lots 0 et 1 terminés, lot 2 prochain (`PENDING`). Registre classpath et routage exact raccordés au catalogue, baseline réelle vide et références de démonstration synthétiques. Validation locale : 352 tests standards et 118 tests PostgreSQL/Testcontainers sans échec ni omission. La branche `feature/V0.1.0-RC01-CODEX-MVP-001` sera livrée par PR vers `feature/V0.1.0-RC01` après ses lots restants ; chaque lot terminé est commité, poussé et contrôlé par CI. Voir le [Work Order](docs/work-orders/MVP-001.md) et le [contrat du registre](docs/contracts/provider-capability-registry-v1.md) ;
