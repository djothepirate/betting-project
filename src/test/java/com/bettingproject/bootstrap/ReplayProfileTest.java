...
class ReplayProfileTest {
    ...
    void replayStartsOfflineWithoutDatabaseInfrastructure() {
        ...
        assertThat(applicationContext.getBeansOfType(FixtureObservationStore.class)).isEmpty();
        assertThat(applicationContext.getBeansOfType(FixtureApplicationJournal.class)).isEmpty();
        assertThat(applicationContext.getBeansOfType(CalendarAuthorityPolicy.class)).isEmpty();
        assertThat(applicationContext.getBeansOfType(RegistryCalendarAuthorityPolicy.class)).isEmpty();
