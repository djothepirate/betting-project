...
Garder les DTO et identifiants source dans les adaptateurs. Respecter identité canonique, autorité PRIMARY/CONTROL, temps source et ordre des participants ; neutralVenue seul n'autorise pas une permutation. Les contraintes de configuration ne s'appliquent pas automatiquement aux littéraux bruts reçus d'une source.
